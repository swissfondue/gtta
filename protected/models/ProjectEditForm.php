...
class ProjectEditForm extends CFormModel
{
	...
	public function rules()
	{
		return array(
            ...
            array( 'deadline', 'date', 'allowEmpty' => false, 'format' => 'yyyy-MM-dd' ),
            array( 'clientId', 'checkClient' ),
            array( 'status', 'in', 'range' => array( Project::STATUS_OPEN, Project::STATUS_IN_PROGRESS, Project::STATUS_FINISHED ) ),
		);
	}
