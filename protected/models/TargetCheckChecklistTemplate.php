...
/**
 * This is the model class for table "target_check_checklist_templates".
 *
 * The followings are the available columns in table "target_check_checklist_templates":
 * @property integer $target_id
 * @property integer $checklist_template_id
 * @property Target $target
 * @property ChecklistTemplate $checklistTemplate
 */
class TargetCheckChecklistTemplate extends ActiveRecord {
    /**
    ...
    public function tableName() {
        return "target_check_checklist_templates";
    }
