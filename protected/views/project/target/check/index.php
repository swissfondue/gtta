                            ...
                            <?php if ($qTarget->categories): ?>
                                <div class="categories">
                                    <?php foreach ($qTarget->categories as $cat): ?>
                                        ...
                                        <a href="<?php echo $this->createUrl("project/checks", array("id" => $project->id, "target" => $qTarget->id, "category" => $cat->id)); ?>" <?php if ($cat->id == $category->check_category_id) echo "class=\"selected\""; ?>><?php echo $catName; ?></a>
                                    <?php endforeach; ?>
                                </div>
                            <?php endif; ?>
                        </div>
