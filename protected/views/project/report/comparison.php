<div class="active-header">
    <div class="pull-right">
        <?php echo $this->renderPartial("//project/partial/submenu", ["page" => "comparison", "project" => $project]); ?>
    </div>
...
<form id="object-selection-form" class="form-horizontal" action="<?php echo Yii::app()->request->url; ?>" method="post" data-object-list-url="<?php echo $this->createUrl("app/objectlist"); ?>">
    ...
    <fieldset>
        ...
        <div class="hide control-group" id="project-list">
            <label class="control-label" for="ProjectComparisonForm_projectId"><?php echo Yii::t("app", "Project"); ?></label>
            <div class="controls">
                <select class="input-xlarge" id="ProjectComparisonForm_projectId" name="ProjectComparisonForm[projectId]" onchange="system.report.comparisonFormChange(this);">
                    <option value="0"><?php echo Yii::t("app", "Please select..."); ?></option>
                </select>
            </div>
        </div>
