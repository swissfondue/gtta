        ...
        <div class="tab-content">
            <div class="tab-pane active" id="default">
                <div class="control-group <?php if ($model->getError('name')) echo 'error'; ?>">
                    <label class="control-label" for="CheckInputEditForm_name"><?php echo Yii::t('app', 'Name'); ?></label>
                    <div class="controls">
                        <input type="text" class="input-xlarge" id="CheckInputEditForm_name" name="CheckInputEditForm[name]" value="<?php echo CHtml::encode($model->name); ?>" onkeyup="admin.check.updateTiedField('CheckInputEditForm_name', 'CheckInputEditForm_localizedItems_<?php echo $defaultLanguage; ?>_name');">
                ...
                <div class="control-group">
                    <label class="control-label" for="CheckInputEditForm_description"><?php echo Yii::t('app', 'Description'); ?></label>
                    <div class="controls">
                        <input type="text" class="input-xlarge" id="CheckInputEditForm_description" name="CheckInputEditForm[description]" value="<?php echo CHtml::encode($model->description); ?>" onkeyup="admin.check.updateTiedField('CheckInputEditForm_description', 'CheckInputEditForm_localizedItems_<?php echo $defaultLanguage; ?>_description');">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="4" class="input-xlarge" id="CheckInputEditForm_value" name="CheckInputEditForm[value]" onkeyup="admin.check.updateTiedField('CheckInputEditForm_value', 'CheckInputEditForm_localizedItems_<?php echo $defaultLanguage; ?>_value');"><?php echo CHtml::encode($model->value); ?></textarea>
                    </div>
                </div>
            </div>
            <?php foreach ($languages as $language): ?>
