<div class="active-header">
    ...
    <div class="pull-right buttons">
        <a class="btn" href="<?php echo $this->createUrl('check/editcheck', array( 'id' => $category->id, 'control' => $control->id )) ?>"><?php echo Yii::t('app', 'New Check'); ?></a>
    </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($checks as $check): ?>
                            <tr data-id="<?php echo $check->id; ?>" data-control-url="<?php echo $this->createUrl('check/control/check/control'); ?>">
                                ...
                                <td class="actions">
                                    <a href="#del" title="<?php echo Yii::t('app', 'Delete'); ?>" onclick="system.check.del(<?php echo $check->id; ?>);"><i class="icon icon-remove"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
