        ...
        <div class="tab-content">
            <div class="tab-pane active" id="default">
                <div class="control-group <?php if ($model->getError('name')) echo 'error'; ?>">
                    <label class="control-label" for="CheckCategoryEditForm_name"><?php echo Yii::t('app', 'Name'); ?></label>
                    <div class="controls">
                        <input type="text" class="input-xlarge" id="CheckCategoryEditForm_name" name="CheckCategoryEditForm[name]" value="<?php echo CHtml::encode($model->name); ?>" onkeyup="admin.check.updateTiedField('CheckCategoryEditForm_name', 'CheckCategoryEditForm_localizedItems_<?php echo $defaultLanguage; ?>_name');">
