    ...
    public function safeUp() {
        ...
        $this->execute(
            "insert into nessus_mapping_vulns 
             (nessus_mapping_id, nessus_plugin_id, nessus_plugin_name, nessus_rating, check_id, rating, check_result_id, check_solution_id)
             values 
             (1, 1, 'Plugin God','None', 1, 100, 1, 1);"
        );
        $this->execute(
            "insert into nessus_mapping_vulns 
             (nessus_mapping_id, nessus_plugin_id, nessus_plugin_name, nessus_rating, check_id, rating, check_result_id, check_solution_id)
             values 
             (1, 2, 'Plugin Dick','Med', 2, 200, 2, 2);"
        );
        $this->execute(
            "insert into nessus_mapping_vulns 
             (nessus_mapping_id, nessus_plugin_id, nessus_plugin_name, nessus_rating, check_id, rating, check_result_id, check_solution_id)
             values 
             (1, 3, 'Plugin Cum','High', 3, 500, 3, 3);"
        );
