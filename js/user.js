    ...
    this.report = new function () {
        ...
        this.projectFormChange = function (e) {
            ...
            if (e.id == 'ProjectReportForm_clientId')
            {
                ...
                if (val != 0)
                {
                    system.control.loadObjects(val, 'project-list', function (data) {
            ...
            else if (e.id == 'ProjectReportForm_projectId')
            {
                ...
                if (val != 0)
                {
                    system.control.loadObjects(val, 'target-list', function (data) {
        ...
        this._refreshChecks = function () {
            ...
            {
                system.control.loadObjects(addTargets[i], 'check-list', function (data) {
                    ...
                    if (data && data.objects.length)
                    {
                        ...
                        for (k = 0; k < data.objects.length; k++)
                        {
                            ...
                            else if (check.rating == system.RATING_MED_RISK)
        ...
        this.riskMatrixFormChange = function (e) {
            ...
            if (e.id == 'RiskMatrixForm_templateId')
            {
                ...
                if (val != 0)
                {
                    system.control.loadObjects(val, 'category-list', function (data) {
                        if (data && data.objects.length)
                        {
        ...
        this._drawEffortTable = function () {
            ...
            for (var i = 0; i < _report._effortList.length; i++)
            {
                ...
                tr = '<tr data-id="' + item.id + '"><td class="name">' + item.name + '</td>' +
                    ...
                    '<td class="actions"><a href="#del" title="' + system.translate('Delete') +
                    '" onclick="user.report.delEffort(' + item.id + ')"><i class="icon icon-remove"></i></a></td</tr>'
